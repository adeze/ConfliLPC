...
from models_recadam.classification_model import ClassificationModel_RecAdam
from models_recadam.multi_label_classification_model import MultiLabelClassificationModel_RecAdam
from models_recadam.ner_model import NERModel_RecAdam
from models_recadam.ner_model import NERModel_RecAdam
...
def train_binary(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model_args.recadam_anneal_fun = args.recadam_anneal_fun
    model_args.recadam_anneal_k = args.recadam_anneal_k
    model_args.recadam_anneal_t0 = args.recadam_anneal_t0
    model_args.recadam_anneal_w = args.recadam_anneal_w
    model_args.recadam_pretrain_cof = args.recadam_pretrain_cof
    ...
    model = ClassificationModel_RecAdam(architecture, pretrained_model, num_labels=len(unique_labels), previous_model=prev_model, args=model_args, ignore_mismatched_sizes=True)
...
def train_multilabel(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = MultiLabelClassificationModel_RecAdam(architecture, pretrained_model, num_labels=args.num_labels, previous_model=prev_model, args=model_args, ignore_mismatched_sizes=True)
...
def train_multiclass(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = ClassificationModel_RecAdam(architecture, pretrained_model, num_labels=args.num_labels, previous_model=prev_model, args=model_args, ignore_mismatched_sizes=True)
...
def train_ner(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = NERModel_RecAdam(architecture, pretrained_model, previous_model=prev_model, args=model_args, ignore_mismatched_sizes=True)
