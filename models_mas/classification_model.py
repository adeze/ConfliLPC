...
class ClassificationModel_MAS:
    ...
    def train(
        ...
        **kwargs,
        ...
        elif args.optimizer == "MAS":
            optimizer = local_sgd(model.reg_params, args.reg_lambda)
        else:
            raise ValueError(
        ...
        for _ in train_iterator:
            ...
            if epoch_number % args.update_epoch == 0:
                ...
                model = compute_omega_grads_norm(args=args, model=model, dataloader=train_dataloader, optimizer=optimizer_ft, use_gpu=True)
                model.eval()

                if epoch_number > 0:
                    model = consolidate_reg_params(model, use_gpu=True)
    ...
    def load_and_cache_examples(
        ...
        if args.sliding_window or self.args.model_type in ["layoutlm", "layoutlmv2"] or args.optimizer == "MAS":
