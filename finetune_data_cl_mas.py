...
from models_mas.classification_model import ClassificationModel_MAS
from models_mas.multi_label_classification_model import MultiLabelClassificationModel_MAS
from models_mas.ner_model import NERModel_MAS
...
def train_binary(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = ClassificationModel_MAS(architecture, pretrained_model, num_labels=len(unique_labels), args=model_args, ignore_mismatched_sizes=True)
...
def train_multilabel(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = MultiLabelClassificationModel_MAS(architecture, pretrained_model, num_labels=args.num_labels, args=model_args, ignore_mismatched_sizes=True)
...
def train_multiclass(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = ClassificationModel_MAS(architecture, pretrained_model, num_labels=args.num_labels, args=model_args, ignore_mismatched_sizes=True)
...
def train_ner(args, task_id, train_df, eval_df, test_df, seed, model, model_configs):
    ...
    model = NERModel_MAS(architecture, pretrained_model, args=model_args, ignore_mismatched_sizes=True)
...
def main():
    ...
    parser.add_argument("--optimizer", type=str, default="MAS", choices=["Adam", "MAS"],
                        help="Choose the optimizer to use. Default MAS.")
